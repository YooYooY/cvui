...
export var AutoComplete = function (props) {
    ...
    useClickOutside(componentRef, function () { return setSuggestion([]); });
    useEffect(function () {
    ...
    var generateDropdown = function () {
        return (React.createElement(Transition, { in: showDropdown || loading, animation: "zoom-in-top", timeout: 300, onExited: function () {
            ...
            React.createElement("ul", { className: "cv-suggestion-list" },
                loading && (React.createElement("div", { className: "cv-suggestion-list-loading" },
                    React.createElement(Icon, { icon: "spinner", spin: true }))),
                suggestion.map(function (item, index) {
                    var cnames = "cv-suggestion-list-item " + (index === highlightIndex ? 'is-active' : '');
                    return (React.createElement("li", { key: index, className: cnames, onClick: function () { return handleSelect(item); } }, renderTemplate(item)));
                }))));
    };
    return (React.createElement("div", { className: "cv-auto-complete", ref: componentRef },
